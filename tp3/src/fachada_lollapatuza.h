...
public:
    ...
    list<Nat> ventasSinDescEnPuesto(IdPuesto idPuesto, Persona persona, Producto producto) const;
    list<Nat> ventasConDescEnPuesto(IdPuesto idPuesto, Persona persona, Producto producto) const;
